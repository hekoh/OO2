...
public abstract class SingleThreadTCPServer {
    ...
    public abstract void CloseConenction();					//Defino un metodo Hook

    public final void handleClient(Socket clientSocket) {	//lo vuelvo publico. Template method?
        ...
        try (
            ...
            while ((inputLine = in.readLine()) != null) {
                ...
                if (KeyWord(inputLine)) { //Client requested to close the connection
                    CloseConenction(); 			//Metodo Hook 1. A definir por las subclases 
                    break;
                }
                handleMessage(inputLine, out);				//Hook. Este metodo lo redefinen las subclases
            }
    ...
    public abstract boolean KeyWord(String line);	
