...
public class TestCatalogo {
	...
	public void setup() {
		...
		this.catalogo.agregarComponente(new Componente("Ryzen 9 9950X", "Ryzen 9 9950X 5.7GHZ, Procesador gamer", 2500.0, 180.0));
		...
		this.catalogo.agregarComponente(new Componente("Gabinete gamer", "Gabinete gamer grande", 750.0, 0.0));
		this.catalogo.agregarComponente(new Componente("Fuente 1110 w", "Fuente 1110.0 w", 1500.0, 0.0));
	}
	...
	public void testBuilderGamer() {
		this.builder = new BuilderGamer(catalogo);
		this.builder.setProcesador();
		this.builder.setDisco();
		this.builder.setRam();
		this.builder.setGrafica();
		this.builder.setGabinete();
		assertEquals(this.builder.getResultado().calcularConsumo(), 740.0);
		assertEquals(this.builder.getResultado().calcularPrecio(), 14132.8);
	}
