...
public class DatabaseAccessProxyTest {
    ...
    public void testLogIn() {
    	assertThrows(RuntimeException.class, () -> proxy.iniciarSesion("prueba fallida"));
    	proxy.iniciarSesion("contraseña");
    	Exception aux = assertThrows(RuntimeException.class, () -> proxy.iniciarSesion("contraseña"));
    	assertEquals(aux.getMessage(), "Sesíon ya iniciada");
    }
